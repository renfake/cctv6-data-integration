...
*
*********************************************************************************/
package com.cctv6.data.dao;

import java.util.List;
import java.util.Map;

import com.cctv6.data.dao.executor.DeleteExecutor;
import com.cctv6.data.dao.executor.UpdateExecutor;
 ...
 */
public interface GenericDao<T extends AbstractDomainObject<PK>, PK extends AbstractPrimaryKey> extends UpdateExecutor<T>, DeleteExecutor<T> {
